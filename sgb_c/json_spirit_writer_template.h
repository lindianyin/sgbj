...
namespace json_spirit
{
    ...
    void append_double( Ostream& os, const double d, const int precision )
    {
        ...
        os << std::fixed << std::showpoint << std::setprecision( precision ) << d;
    }
    ...
    private:
        ...
        void output( double d )
        {
            if( remove_trailing_zeros_ )
            {
                ...
                //append_double( os, d, 16 );  wlj 20130614
                append_double( os, d, 2 );  // note precision is 16 so that we get some trailing space that we can remove,
            ...
            {
                //append_double( os_, d, 17 );    wlj 20130614
                append_double( os_, d, 2 );
            }
        }
